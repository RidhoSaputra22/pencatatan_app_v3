...
import { LineChart, StackedBarChart, InOutDoughnutChart } from "@/components/dashboard/Charts";
      ...
      <div className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-base-content/50">Pantau aktivitas pengunjung secara real-time</p>
          </div>
      ...
      <div className="card bg-gradient-to-r from-primary/5 via-base-100 to-info/5 shadow-lg border border-base-200/60 p-5">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-medium text-base-content/50">Total aktivitas hari ini</p>
              <p className="text-3xl font-extrabold text-base-content tracking-tight">
                <CountUp end={totalEvents} duration={1.5} separator="." preserveValue />
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-8">
            <div className="text-center">
              <div className="flex items-center gap-1.5 text-success mb-1">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.5 10.5 12 3m0 0 7.5 7.5M12 3v18" /></svg>
                <span className="text-2xl font-bold"><CountUp end={totalIn} duration={1.2} separator="." preserveValue /></span>
              </div>
              <p className="text-xs text-base-content/40">Masuk</p>
            </div>
            <div className="text-center">
              <div className="flex items-center gap-1.5 text-error mb-1">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19.5 13.5 12 21m0 0-7.5-7.5M12 21V3" /></svg>
                <span className="text-2xl font-bold"><CountUp end={totalOut} duration={1.2} separator="." preserveValue /></span>
              </div>
            ...
            <div className="text-center">
              <div className="flex items-center gap-1.5 text-info mb-1">
                ...
                <span className="text-2xl font-bold"><CountUp end={uniqueVisitors} duration={1.2} separator="." preserveValue /></span>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="!shadow-lg">
          <div className="flex items-center justify-between mb-4">
            ...
            {isToday && (
              <span className="text-[10px] px-2 py-0.5 bg-primary/10 text-primary rounded-full font-bold">LIVE</span>
            )}
          </div>
          <LineChart
