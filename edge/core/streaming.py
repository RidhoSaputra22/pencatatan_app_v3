...
def health():
    ...
    return {
        ...
        "video_test_profile": {
            ...
            "bytetrack_low_thresh": BYTETRACK_LOW_THRESH,
            ...
            "reid_frame_interval": REID_FRAME_INTERVAL,
            "reid_min_crop_width": REID_MIN_CROP_WIDTH,
            "reid_min_crop_height": REID_MIN_CROP_HEIGHT,
            "reid_crop_padding_ratio": REID_CROP_PADDING_RATIO,
            "reid_stitch_match_threshold": REID_STITCH_MATCH_THRESHOLD,
