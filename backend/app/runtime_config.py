...
CONFIG_ITEMS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "help": "Pilih algoritma tracking utama. ByteTrack ringan dan stabil untuk stream CCTV tanpa embedder ReID.",
    },
    {
        "key": "FORCE_CENTROID",
        "group": "tracking",
...
CONFIG_HINTS: Dict[str, str] = {
    ...
    "TRACKER_METHOD": "Metode tracking utama. Auto mempertahankan perilaku lama: DeepSORT bila tersedia, atau centroid bila dipaksa/DeepSORT tidak tersedia. ByteTrack ringan dan menjaga ID lebih baik dari centroid pada deteksi yang putus-nyambung, tetapi tidak menghasilkan embedding ReID.",
