...
CONFIG_HINTS: Dict[str, str] = {
    ...
    "IDENTITY_MODE": "Sumber identitas visitor . ReID memakai body embedding yang bisa diambil terpisah dari tracker, face memakai embedding wajah, track memakai ID tracker fallback. Mode yang tidak sesuai data kamera bisa membuat unique visitor pecah atau tergabung salah.",
