...
CONFIG_HINTS: Dict[str, str] = {
    ...
    "EDGE_RECORDING_ENABLED": "Mengaktifkan atau mematikan backup otomatis ke daftar Rekaman CCTV. Saat dimatikan, segmen yang sedang berjalan dibuang dan file baru tidak dibuat sampai diaktifkan lagi.",
    ...
    "EDGE_RECORDING_SEGMENT_MINUTES": "Durasi setiap file rekaman otomatis. Perubahan berlaku pada segmen berikutnya setelah edge worker mengambil config. Nilai lebih pendek membuat file cepat muncul tetapi jumlah file bertambah.",
    ...
    "EDGE_RECORDING_MAX_GAP_SECONDS": "Jika frame berhenti lebih lama dari nilai ini, segmen parsial direset agar file yang selesai tidak berisi loncatan waktu besar.",
